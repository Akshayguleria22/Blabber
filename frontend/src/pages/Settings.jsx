          ...
          <section id="profile" className="card bg-base-100 shadow">
            <div className="card-body">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <form onSubmit={handleProfileUpdate} className="w-full max-w-sm flex flex-col gap-3"><input type="file" accept="image/*" className="file-input file-input-bordered w-full" onChange={handleProfilePicChange} />
          ...
          <section id="privacy" className="card bg-base-100 shadow">
            <div className="card-body">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <label className="label cursor-pointer justify-between"><span className="label-text">Read receipts</span>
